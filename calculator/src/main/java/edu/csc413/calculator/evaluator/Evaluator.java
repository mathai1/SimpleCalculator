    ...
    while ( this.expressionTokenizer.hasMoreTokens() ) {
      ...
      if ( !( expressionToken = this.expressionTokenizer.nextToken() ).equals( " " )) {
        ...
        if ( Operand.check( expressionToken )) {
          ...
          //checks if operator equals open parenthesis
          if("(".equals(expressionToken)){
            operatorStack.push(newOperator);
          }
          //checks if operator equals close parenthesis
          ...
          // if other operators
            ...
            while (!operatorStack.empty()&& !operatorStack.peek().equals("(") && operatorStack.peek().priority() >= newOperator.priority()) {
              Operator operatorFromStack = operatorStack.pop();
              Operand operandTwo = operandStack.pop();
              Operand operandOne = operandStack.pop();
              Operand result = operatorFromStack.execute(operandOne, operandTwo);
